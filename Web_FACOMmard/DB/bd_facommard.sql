...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 11 fév. 2025 à 17:12
...
CREATE TABLE `commandes` (
  ...
  `session_stripe` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `commandes` (`commande_id`, `utilisateur_id`, `date_commande`, `statut_commande`, `adresse_livraison`, `montant_total`, `mode_paiement`, `session_stripe`) VALUES
(4, 3, '2025-02-11 16:05:38', 'en attente', '16 touleuse , cergy, frnace, cergy, 95000', 0.55, 'carte', 'cs_live_a1ZEzsv2exn5VYvvSuESljuqJlNHLQWlpqUUyqkulOzTr69WY2oTVjCErq');
...
INSERT INTO `details_commande` (`details_commande_id`, `commande_id`, `produit_id`, `quantite`, `prix_unitaire`) VALUES
(4, 4, 1, 1, 0.55);
...
INSERT INTO `produits` (`produit_id`, `nom`, `reference`, `code_barre`, `description`, `prix`, `image_url`, `poids`, `hauteur`, `largeur`, `longueur`, `categorie_id`, `statut`, `date_ajout`) VALUES
(1, 'Tournevis Facom', 'REF-TOUR01', '1234567890123', 'Tournevis ergonomique.', 0.55, 'img/tournevis.jpg', 0.20, 15.00, 3.00, 2.00, 1, 'actif', '2025-01-26 23:19:45'),
(2, 'Marteau professionnel', 'REF-MARTEAU01', '1234567890456', 'Marteau avec poignée antichoc.', 25.00, 'img/marteau.jpg', 1.50, 35.00, 10.00, 5.00, 1, 'actif', '2025-01-26 23:19:45'),
(3, 'Perceuse Bosch', 'REF-PERCEUSE01', '1234567890789', 'Perceuse puissante.', 150.00, 'img/perceuse.jpg', 3.20, 40.00, 12.00, 8.00, 2, 'actif', '2025-01-26 23:19:45'),
(4, 'Scie circulaire', 'REF-SCIE01', '1234567890999', 'Scie robuste.', 199.99, 'img/scie.jpg', 4.50, 50.00, 20.00, 15.00, 3, 'actif', '2025-01-26 23:19:45');
...
(1, 'Dupont', 'Jean', 'jean.dupont@example.com', 'b6edd10559b20cb0a3ddaeb15e5267cc', '0102030405', '66 Rue de Montreuil, Paris', 'etudiant', '2025-01-26 23:19:45'),
(2, 'Admin', 'Super', 'admin@example.com', 'c93ccd78b2076528346216b3b2f701e6', NULL, NULL, 'admin', '2025-01-26 23:19:45'),
(3, 'Salah', 'hassani', 'salah123@gmail.com', '$2y$10$aGRa1dVw7SorAB4Gvr/k4O/RmDlTiQM.CFsteJAqV2ZgPY6uRZWJS', '0769314578', '16 touleuse , cergy, frnace', 'etudiant', '2025-02-11 15:49:50');
...
--
ALTER TABLE `details_commande`
  MODIFY `details_commande_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `panier`
  MODIFY `panier_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `avis`
  ADD CONSTRAINT `fk_produit` FOREIGN KEY (`produit_id`) REFERENCES `produits` (`produit_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_utilisateur` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateurs` (`utilisateur_id`) ON DELETE CASCADE;
